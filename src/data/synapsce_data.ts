  ...
  patients: [
    {
      ...
      currentConventionalTreatments: [
        ...
        },
        {
          ...
          dosage: "60mg 1x/jour",
          notes:
            "Peu d'amélioration sur les douleurs, aide modérément l'humeur",
        },
      ],
      previousAttempts: ["AINS (inefficaces)", "Tramadol (mal toléré)"],
      physicianNote:
        "Patiente présentant une fibromyalgie invalidante avec un retentissement majeur sur la qualité de vie. Les options thérapeutiques conventionnelles ont montré leurs limites. Patiente ouverte à explorer des approches complémentaires pour la gestion de la douleur, du sommeil et de l'anxiété.",
    },
    {
      id: "patient_002",
      ...
      currentConventionalTreatments: [
        ...
        },
        {
          ...
          notes:
            "Amélioration modérée de la mobilité, mais douleur persistante",
        },
      ],
      previousAttempts: ["Paracétamol (peu efficace)"],
      physicianNote:
        "Patient souffrant de lombalgie chronique impactant ses activités quotidiennes. La physiothérapie a apporté un certain soulagement mais les douleurs persistent. Patient intéressé par des approches pour renforcer son dos et gérer la douleur autrement.",
    },
    {
      id: "patient_003",
      ...
      age: 41,
      primaryDiagnosis:
        "Syndrome de l'intestin irritable (SII) à prédominance diarrhéique",
      relevantHistory: [
      ...
      currentConventionalTreatments: [
        {
          ...
          dosage: "Au besoin",
          notes:
            "Contrôle les épisodes diarrhéiques mais ne résout pas le fond",
        },
        {
      ...
      physicianNote:
        "Patiente avec un SII affectant significativement sa qualité de vie et sa vie sociale. Les traitements symptomatiques sont utiles ponctuellement. Patiente motivée pour trouver des solutions de fond, notamment pour la gestion du stress et l'équilibre digestif.",
    },
  ],
  conditions: [
    {
      ...
      conventionalTreatmentChallenges: [
        "Efficacité limitée des antalgiques",
        "Effets secondaires des médicaments",
        "Approche souvent symptomatique",
      ],
    },
    {
      id: "cond_002",
      ...
      commonSymptoms: [
        "Douleur persistante bas du dos",
        "Raideur",
        "Mobilité réduite",
        "Irradiation possible (sciatique)",
      ],
      conventionalTreatmentChallenges: [
    ...
    },
    {
      ...
      conventionalTreatmentChallenges: [
        "Pathologie fonctionnelle complexe",
        "Impact du stress et de l'alimentation",
    ...
    },
    {
      ...
      conventionalTreatmentChallenges: [
        ...
        "Gestion des causes sous-jacentes (stress, anxiété)",
        "Hygiène du sommeil",
      ],
    },
  ],
  complementaryApproaches: [
    {
      ...
      name: "Acupuncture",
      description:
        "Stimulation de points spécifiques du corps, souvent avec de fines aiguilles, pour rétablir l'équilibre énergétique et soulager divers maux.",
    ...
    },
    {
      ...
      description:
        "Technique de gestion du stress et des émotions par l'attention focalisée sur le moment présent, sans jugement.",
      keywords: [
        "stress",
        "anxiété",
        "douleur chronique",
    ...
    },
    {
      ...
      name: "Phytothérapie",
      description:
        "Utilisation des plantes médicinales (extraits, tisanes, huiles essentielles) pour prévenir ou traiter des troubles de santé.",
      keywords: [
        "plantes",
        "naturel",
        "sommeil",
    ...
    },
    {
      ...
      name: "Ostéopathie",
      description:
        "Thérapie manuelle visant à restaurer la mobilité des différentes structures du corps (articulations, muscles, fascias, viscères).",
    ...
    },
    {
      ...
      description:
        "Application des postures, techniques de respiration et de méditation du yoga dans un but de prévention ou de soin spécifique.",
    ...
    },
    {
      ...
      description:
        "Technique visant à induire un état de conscience modifié pour accéder aux ressources de l'inconscient et faciliter le changement.",
      keywords: [
        "inconscient",
        "changement",
        "douleur",
    ...
    },
    {
      ...
      description:
        "Méthode psychocorporelle utilisant des techniques de relaxation dynamique, de respiration et de visualisation positive.",
      keywords: [
        "relaxation",
        "conscience",
        "corps-esprit",
    ...
    },
    {
      ...
      description:
        "Approche basée sur l'optimisation de l'apport en micronutriments (vitamines, minéraux, oligo-éléments, acides aminés, etc.) et l'équilibre alimentaire pour maintenir ou restaurer la santé.",
      keywords: [
        "alimentation",
        "vitamines",
        "minéraux",
  ...
  sources: [
    {
      id: "src_001",
      title:
        "Approches complémentaires dans la fibromyalgie : une revue systématique",
      ...
      summary:
        "Analyse de l'efficacité de diverses approches complémentaires (acupuncture, MBSR, yoga) pour la gestion des symptômes de la fibromyalgie.",
    ...
    },
    {
      ...
      summary:
        "Informations générales, conseils pour les patients, ressources et soutien pour les personnes atteintes de fibromyalgie.",
      relatedConditions: ["cond_001"],
    },
    {
      id: "src_003",
      title:
        "Vidéo éducative SYNAPSCE : Fibromyalgie : Mieux comprendre pour mieux gérer",
      ...
      summary:
        "Explication claire de la fibromyalgie, des mécanismes de la douleur et des stratégies de gestion, incluant l'intérêt des approches intégratives.",
      relatedConditions: ["cond_001"],
    },
    {
      id: "src_004",
      ...
      summary:
        "Propriétés, usages traditionnels, précautions d'emploi de la valériane et de la passiflore pour les troubles du sommeil et l'anxiété légère.",
    ...
    },
    {
      id: "src_005",
      title:
        "L'acupuncture dans le traitement de la lombalgie chronique : une méta-analyse",
      ...
      summary:
        "Compilation des résultats de plusieurs études démontrant l'efficacité de l'acupuncture pour réduire la douleur et améliorer la fonction chez les patients avec lombalgie chronique.",
    ...
    },
    {
      id: "src_006",
      title:
        "Bienfaits de la méditation de pleine conscience sur le syndrome de l'intestin irritable",
      ...
      summary:
        "Étude montrant une réduction significative des symptômes du SII et une amélioration de la qualité de vie chez les patients ayant suivi un programme MBSR.",
    ...
    },
    {
      ...
      summary:
        "Vidéo pédagogique expliquant le mécanisme d'action des vaccins de manière simple et accessible.",
    ...
    },
    {
      ...
      summary:
        "Exploration des mécanismes cérébraux impliqués dans les addictions et les pistes pour s'en libérer.",
      keywords: ["addiction", "cerveau", "neuroscience", "comportement"],
    },
    {
      id: "src_009",
      title:
        "Le rôle de la micronutrition dans les maladies inflammatoires chroniques",
      ...
      summary:
        "Revue des évidences sur l'impact des carences et des supplémentations en micronutriments sur l'inflammation chronique.",
  ...
  practitioners: [
    {
      ...
      synapsceNote:
        "Expérience confirmée avec des patients fibromyalgiques. Approche intégrative et à l'écoute.",
      contactInfo: {
    ...
    },
    {
      ...
      locationCity: "Pully",
      synapsceNote:
        "Bons retours patients pour la gestion des douleurs diffuses et l'amélioration du sommeil.",
      contactInfo: {
    ...
    },
    {
      ...
      locationCity: "Genève",
      synapsceNote:
        "Approche douce et globale, appréciée pour les douleurs vertébrales.",
      contactInfo: {
    ...
    },
    {
      ...
      synapsceNote:
        "Anime des cycles MBSR de 8 semaines et des ateliers découvertes. Pédagogie claire et engageante.",
      contactInfo: {
    ...
    },
    {
      ...
      specializations: [
        ...
        "Préparation aux examens/événements",
        "Troubles du sommeil",
        "Confiance en soi",
      ],
      locationCity: "Morges",
      synapsceNote:
        "Accompagnement personnalisé pour retrouver un équilibre corps-esprit.",
      contactInfo: {
